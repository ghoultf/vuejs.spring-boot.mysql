...
import com.taskagile.app.domain.application.commands.AddCardAttachmentCommand;
...
import com.taskagile.app.domain.model.activity.Activity;
import com.taskagile.app.domain.model.activity.ActivityRepository;
import com.taskagile.app.domain.model.activity.ActivityType;
import com.taskagile.app.domain.model.activity.CardActivity;
import com.taskagile.app.domain.model.attachment.Attachment;
import com.taskagile.app.domain.model.attachment.AttachmentManagement;
import com.taskagile.app.domain.model.attachment.AttachmentRepository;
import com.taskagile.app.domain.model.attachment.events.CardAttachmentAddedEvent;
...
import com.taskagile.app.domain.model.card.events.CardDescriptionChangedEvent;
import com.taskagile.app.domain.model.card.events.CardTitleChangedEvent;
...
public class CardServiceImpl implements CardService {
  ...
  public CardServiceImpl(CardRepository cardRepository, CardListRepository cardListRepository,
      ActivityRepository activityRepository, AttachmentRepository attachmentRepository,
      AttachmentManagement attachmentManagement, DomainEventPublisher domainEventPublisher) {
