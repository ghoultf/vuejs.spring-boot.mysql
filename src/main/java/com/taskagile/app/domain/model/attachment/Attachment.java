package com.taskagile.app.domain.model.attachment;
...
public class Attachment extends AbstractBaseEntity {
  ...
  public static Attachment create(CardId cardId, UserId userId, String fileName, String filePath,
  ...
  public boolean equals(Object o) {
    ...
    return cardId == that.cardId && userId == that.userId && archived == that.archived
  ...
  public String toString() {
    return "Attachment{" + "id=" + id + ", cardId=" + cardId + ", userId=" + userId + ", fileName='" + fileName + '\''
        + ", filePath='" + filePath + '\'' + ", fileType='" + fileType + '\'' + ", thumbnailCreated=" + thumbnailCreated
        + ", archived=" + archived + ", createdDate=" + createdDate + '}';
  }
}
