...
public class Activity extends AbstractBaseEntity {
  ...
  public boolean equals(Object o) {
    ...
    return userId == activity.userId && type == activity.type && Objects.equals(cardId, activity.cardId)
        && Objects.equals(boardId, activity.boardId) && Objects.equals(detail, activity.detail)
  ...
  public String toString() {
    return "Activity{" + "id=" + id + ", userId=" + userId + ", cardId=" + cardId + ", boardId=" + boardId + ", type="
        + type + ", detail='" + detail + '\'' + ", createdDate=" + createdDate + '}';
  }
}
