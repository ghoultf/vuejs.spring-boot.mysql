...
public enum ActivityType {
  UNKNOWN(""), CREATE_BOARD("create-board"), RENAME_BOARD("rename-board"), ARCHIVE_BOARD("archive-board"),
  ADD_BOARD_MEMBER("add-board-member"), REMOVE_BOARD_MEMBER("remove-board-member"), ADD_CARD_LIST("add-card-list"),
  RENAME_CARD_LIST("rename-card-list"), ARCHIVE_CARD_LIST("archive-card-list"), ADD_CARD("add-card"),
  CHANGE_CARD_TITLE("change-card-title"), CHANGE_CARD_DESCRIPTION("change-card-description"),
  ASSIGN_MEMBER_TO_CARD("assign-member-to-card"), REMOVE_MEMBER_FROM_CARD("remove-member-from-card"),
  ADD_ATTACHMENT("add-attachment"), REMOVE_ATTACHMENT("remove-attachment"), ARCHIVE_CARD("archive-card"),
  DELETE_CARD("delete-card"), ADD_COMMENT("add-comment"), EDIT_COMMENT("edit-comment"),
