      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="wrapper attachments-wrapper" v-show="attachments.length">
              ...
              <div class="wrapper-body">
                <div class="uploading" v-show="uploadingCount">
                  <font-awesome-icon icon="spinner" class="fa-spin" spin/>Uploading...
                </div>
                <ul class="list-unstyled">
                  <li class="media" v-for="attachment in cardAttachments" v-bind:key="attachment.id">
                    <div class="mr-3">
                      ...
                      <div class="preview file-type" v-if="!attachment.previewUrl">{{ attachment.fileType }}</div>
                    </div>
              ...
              <div class="wrapper-body">
                <div class="activity" v-for="activity in cardActivities" v-bind:key="activity.id">
                  <div>
                    ...
                    <span class="when">{{ activity.when }} ago</span>
                  </div>
          ...
          <div class="card-controls">
            ...
            <div class="control">
              <uploader id="cardAttachment" :url="attachmentUploadUrl" icon="paperclip" label="Attachment" @uploading="onUploadingAttachment" @progress="onUploadingProgressUpdated" @failed="onAttachmentUploadFailed" @uploaded="onAttachmentUploaded"/>
            </div>
